...
include_once ZMXY_PATH.'zmop/request/ZhimaCreditAntifraudVerifyRequest.php';
defined('SIGNTYPE') or define('SIGNTYPE','RSA');//签名方式,默认为RSA,可使用RSA2

class ZhimaCreditAntifraudVerify extends  controller
{
    //芝麻信用网关地址
     ...
     * @return 查询芝麻欺诈信息
     */
    public function zhimaQueryVerify($pram)
    {
