...
include_once ZMXY_PATH.'zmop/request/ZhimaCreditAntifraudScoreGetRequest.php';
defined('SIGNTYPE') or define('SIGNTYPE','RSA');//签名方式,默认为RSA,可使用RSA2

class ZhimaCreditAntifraudScoreGet extends controller
{
    //芝麻信用网关地址
     ...
     */
    public function zhimaAntifraudScore($pram)
    {
